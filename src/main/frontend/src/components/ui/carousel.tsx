...
const Carousel = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & TCarouselProps>(
...
export { Carousel, CarouselContent, CarouselItem, CarouselNext, CarouselPrevious, type TCarouselApi };
