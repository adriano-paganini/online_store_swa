...
type TDualRangeSliderProps = React.ComponentProps<typeof SliderPrimitive.Root> & {
  labelPosition?: 'top' | 'bottom';
  label?: (value: number | undefined) => React.ReactNode;
};

const DualRangeSlider = React.forwardRef<React.ElementRef<typeof SliderPrimitive.Root>, TDualRangeSliderProps>(
